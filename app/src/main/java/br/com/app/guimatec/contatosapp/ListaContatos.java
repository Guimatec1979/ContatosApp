package br.com.app.guimatec.contatosapp;
...
public class ListaContatos extends ListActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        contactAdapter = new SimpleCursorAdapter(
                ListaContatos.this, R.layout.contato_list_item, null, from, to);
    ...
    private class GetContactsTask extends AsyncTask<Object, Object, Cursor>
    {
        DatabaseConnector databaseConnector =
                new DatabaseConnector(ListaContatos.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        Intent addNewContact =
                new Intent(ListaContatos.this, AddEditContato.class);
    ...
    OnItemClickListener viewContactListener = new OnItemClickListener()
    {
                                ...
                                long arg3)
        {
            ...
            Intent viewContact =
                    new Intent(ListaContatos.this, ViewContact.class);
