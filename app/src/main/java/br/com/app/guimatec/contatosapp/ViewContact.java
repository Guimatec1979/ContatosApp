...
public class ViewContact extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        rowID = extras.getLong(ListaContatos.ROW_ID);
    } // end method onCreate
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        inflater.inflate(R.menu.view_contato_menu, menu);
        return true;
        ...
        switch (item.getItemId()) // switch based on selected MenuItem's ID
        {
            case R.id.editItem:
                ...
                Intent addEditContact =
                        new Intent(this, AddEditContato.class);

                // pass the selected contact's data as extras with the Intent
                addEditContact.putExtra(ListaContatos.ROW_ID, rowID);
